...
func main() {
  ...
  if (i == 1) || (i == 21) || (i == 31) {
    fmt.Println("Выполнена ", i," итерация вычисления.")
  } else {
      if ((1 < i) && (i < 5)) || ((21 < i) && (i < 25)) || ((31 < i) && (i < 35)) {                        //if (1 < i < 5) || (21 < i < 25) || (31 < i < 35) {
        fmt.Println("Выполнено ", i," итерации вычисления.")
      } else {
        fmt.Println("Выполнено ", i," итераций вычисления.")
      }
  }
